...
WebUI.waitForElementClickable(findTestObject('Page_CheckoutOverview/button_checkoutoverview_cancel'), 2)

WebUI.click(findTestObject('Page_CheckoutOverview/button_checkoutoverview_cancel'))
WebUI.closeBrowser()
