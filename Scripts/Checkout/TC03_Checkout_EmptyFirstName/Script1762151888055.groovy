...
WebUI.setText(findTestObject('Page_Checkout/input_checkout_first-name'), '')
...
WebUI.verifyElementText(findTestObject('Page_Checkout/alert_firstname_required'), 'Error: First Name is required')
