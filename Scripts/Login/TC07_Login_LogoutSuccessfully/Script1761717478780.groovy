...
WebUI.waitForElementVisible(findTestObject('Page_Inventory/logout_button'), 10)
WebUI.waitForElementClickable(findTestObject('Page_Inventory/logout_button'), 10)
