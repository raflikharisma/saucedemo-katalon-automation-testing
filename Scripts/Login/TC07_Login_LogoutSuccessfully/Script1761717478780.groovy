...
WebUI.waitForElementVisible(findTestObject('Page_Dashboard/burger_button'), 10)
WebUI.waitForElementClickable(findTestObject('Page_Dashboard/burger_button'), 10)
WebUI.click(findTestObject('Page_Dashboard/burger_button'))
WebUI.waitForElementVisible(findTestObject('Page_Dashboard/logout_button'), 10)
WebUI.waitForElementClickable(findTestObject('Page_Dashboard/logout_button'), 10)
